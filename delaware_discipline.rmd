...
pop_hawaiian_pi <- pops |> 
    ...
    summarize(total_enrollment=sum(enrollment)) 
paste(pop_hisp, " ", pop_native_am," ",  pop_black," ",  pop_white," ",  pop_asian_am," ",  pop_multi_racial," ",  pop_hawaiian_pi)
```
...
pop_hisp |> 
    ...
    select(sub_group)
    group_by(category, enrollment) |> 
    summarize(enrollment) |>  #this summarize should get rid of duplicates but given the results above when I used
